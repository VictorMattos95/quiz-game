...
const perguntas = [
  ...
  {
    "id": 3,
    "pergunta": "Qual comando é usado para enviar mensagens a todos os usuários conectados no momento? (Especifique SOMENTE o comando, sem nenhum caminho ou parâmetro.)",
    "tipo": "fill",
  ...
  {
    "id": 18,
    "pergunta": "Qual é a finalidade de uma unidade de montagem do sistema?",
    "opcoes": {
  ...
  },
  {
    ...
    "opcoes": {
      ...
      "B": "Aplique o arquivo de patch ao diretório de origem do kernel que contém a versão 4.6.0 do kernel",
      "C": "Aplique o arquivo de patch ao diretório de origem do kernel que contém a versão 4.6.3 do kernel",
  ...
  {
    "id": 37,
    "pergunta": "Após compilar e instalar manualmente um novo kernel, o que deve ser feito em relação ao <code>initramfs</code>?",
    "opcoes": {
